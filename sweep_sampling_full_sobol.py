...
# Generate 15 random odd integers between 1 and 359
ints = np.random.choice(np.arange(1, 360, 2), size=15, replace=False).tolist()

# Generate 15 random floats between 0.0 and 359.9
floats = (np.random.rand(15) * 359.9).tolist()

# Combine into one list
FIXED_DPSI = floats + ints
